...
const int stepsPerRevolution = 2048/2;  // change this to fit the number of steps per r¢evolution
...
void setup() 
{
  ...
  ledcSetClockSource(ledcGetClockSource());

  ledcAttach(RED_PIN, 5000,8);  // Attach GPIO 25 to LEDC channel 0
